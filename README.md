...
Optionally you can build an image and push to the registry with:
```bash
docker buildx build --platform linux/amd64 -f docker/Dockerfile -t ghcr.io/noahclemmensen/carmeetsdenmark:0.4.3 --push .
```
